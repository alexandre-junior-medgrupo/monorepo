...
export const list7 = [
  ...
  },
  {
    ...
    class: [`${TpThemeCSSClasses.InscricoesCPMed}`],
    color: '#f5b4a3',
  },
  {
  ...
  {
    name: 'Especialidade',
    class: [`${TpThemeCSSClasses.Especialidade}`],
    color: '#c4ff4d',
  },
  {
    name: 'Especialidade Light',
    class: [
      `${TpThemeCSSClasses.Especialidade}`,
      `${TpSchemeCSSClasses.Light}`,
    ],
    color: '#b5d279',
  },
  {
    name: 'Especialidade Clinica',
    class: [`${TpThemeCSSClasses.EspecialidadeClinica}`],
    color: '#db5000',
  },
  {
    name: 'Especialidade Clinica Light',
    class: [
      `${TpThemeCSSClasses.EspecialidadeClinica}`,
      `${TpSchemeCSSClasses.Light}`,
    ],
    color: '#a45f37',
  },
